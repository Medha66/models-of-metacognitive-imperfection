...
bsite_sem(:,1) = std(measure(:,1)-measure(:,3))./sqrt(num_subjects); %S1 vs aPFC
bsite_sem(:,2) = std(measure(:,1)-measure(:,2))./sqrt(num_subjects); %S1 vs DLPFC
bsite_sem(:,3) = std(measure(:,1)-measure(:,3))./sqrt(num_subjects); %S1 vs aPFC
