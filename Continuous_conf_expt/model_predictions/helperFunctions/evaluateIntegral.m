...
% Numerically evaluate the double integral with gamma and normal functions
% to determine the prop of high confidence trials
%Shape parameter - mu2, scale parameter - metaNoise
...
elseif strcmp(modelToFit,'normal')
    %Gaussian additive noise (or standard model with no metaNoise)    
